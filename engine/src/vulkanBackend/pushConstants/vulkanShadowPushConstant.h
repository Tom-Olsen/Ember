#ifndef __INCLUDE_GUARD_vulkanShadowPushConstant_h__
#define __INCLUDE_GUARD_vulkanShadowPushConstant_h__
#include "emberMath.h"
#include <string>
...
#endif // __INCLUDE_GUARD_vulkanShadowPushConstant_h__
#ifndef __INCLUDE_GUARD_gameEditorWindow_h__
#define __INCLUDE_GUARD_gameEditorWindow_h__
#include "dearImGui.h"
#include "editor.h"
...
{
    struct GameEditorWindow : EditorWindow
    {
        GameEditorWindow()
        {
            m_name = "Game";
            m_ID = 0;
            m_windowFlags = DearImGuiWindowFlag_NoCollapse | DearImGuiWindowFlag_NoScrollbar | DearImGuiWindowFlag_NoScrollWithMouse;
...
#endif // __INCLUDE_GUARD_gameEditorWindow_h__
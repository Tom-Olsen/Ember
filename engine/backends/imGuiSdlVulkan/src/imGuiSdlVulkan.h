...
namespace imGuiSdlVulkanBackend
{
	...
	public: // Methods
		...
		bool InputUint(const char* label, uint32_t* value, uint32_t step = 1, uint32_t stepFast = 100, emberCommon::GuiInputTextFlags flags = emberCommon::GuiInputTextFlags::none) override;

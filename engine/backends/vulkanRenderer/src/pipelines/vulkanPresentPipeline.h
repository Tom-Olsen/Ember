#ifndef __INCLUDE_GUARD_vulkanRendererBackend_vulkanPresentPipeline_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_vulkanPresentPipeline_h__
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_vulkanPresentPipeline_h__
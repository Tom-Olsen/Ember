...
namespace vulkanRendererBackend
{
    ...
    SkyboxPipeline<vertexLayout>::SkyboxPipeline(const std::string& name, const std::vector<char>& vertexCode, const std::vector<char>& fragmentCode, const std::vector<VkDescriptorSetLayout>& vkDescriptorSetLayouts, const std::vector<VkVertexInputBindingDescription>& vertexBindings, const std::vector<VkVertexInputAttributeDescription>& vertexAttributes)
    {
        m_name = name;
        ...
        NAME_VK_OBJECT(m_pipeline, m_name + "SkyboxPipeline");
    }
    template<typename vertexLayout>
    SkyboxPipeline<vertexLayout>::~SkyboxPipeline()
    {
    ...
    // Private:
    template<typename vertexLayout>
    void SkyboxPipeline<vertexLayout>::CreatePipelineLayout(const std::vector<VkDescriptorSetLayout>& vkDescriptorSetLayouts)
    {
        ...
        NAME_VK_OBJECT(m_pipelineLayout, m_name + "SkyboxPipelineLayout");
    }
    template<typename vertexLayout>
    void SkyboxPipeline<vertexLayout>::CreatePipeline(const VkShaderModule& vertexShaderModule, const VkShaderModule& fragmentShaderModule, const std::vector<VkVertexInputBindingDescription>& vertexBindings, const std::vector<VkVertexInputAttributeDescription>& vertexAttributes)
    {
        // Vertex shader:

...
namespace vulkanRendererBackend
{
    ...
    // Private:
    void ForwardOpaquePipeline::CreatePipelineLayout(const std::vector<VkDescriptorSetLayoutBinding>& vkDescriptorSetLayoutBindings)
    {
    ...
    void ForwardOpaquePipeline::CreatePipeline(const VkShaderModule& vertexShaderModule, const VkShaderModule& fragmentShaderModule, const VertexInputDescriptions* const pVertexInputDescriptions)
    {
        // Vertex shader:

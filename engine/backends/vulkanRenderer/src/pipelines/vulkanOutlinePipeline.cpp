...
namespace vulkanRendererBackend
{
		...
		const std::string& debugName)
	{
		...
		VkShaderModule vertexShaderModule = CreateShaderModule(vertexCode, "ShaderModule_OutlineVertex_" + debugName);
		VkShaderModule fragmentShaderModule = CreateShaderModule(fragmentCode, "ShaderModule_OutlineFragment_" + debugName);
		...
		NAME_VK_OBJECT(m_pipeline, "Pipeline_Outline_" + debugName);
	}
	OutlinePipeline::~OutlinePipeline()
	{

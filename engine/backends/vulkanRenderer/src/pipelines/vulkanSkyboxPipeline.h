...
namespace vulkanRendererBackend
{
	...
	{
	public: // Methods:
		SkyboxPipeline(const std::string& name, const std::vector<char>& vertexCode, const std::vector<char>& fragmentCode, const emberSpirvReflect::ShaderReflection& shaderReflection);
		~SkyboxPipeline();

#ifndef __INCLUDE_GUARD_vulkanRendererBackend_vulkanSkyboxPipeline_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_vulkanSkyboxPipeline_h__
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_vulkanSkyboxPipeline_h__
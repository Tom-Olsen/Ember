...
namespace vulkanRendererBackend
{
    ...
    PresentPipeline<vertexLayout>::PresentPipeline(const std::string& name, const std::vector<char>& vertexCode, const std::vector<char>& fragmentCode, const emberSpirvReflect::ShaderReflection& shaderReflection)
    {
        m_name = name;
    ...
    // Private:
    template<typename vertexLayout>
    void PresentPipeline<vertexLayout>::CreatePipelineLayout(const emberSpirvReflect::ShaderReflection& shaderReflection)
    {
    ...
    template<typename vertexLayout>
    void PresentPipeline<vertexLayout>::CreatePipeline(const VkShaderModule& vertexShaderModule, const VkShaderModule& fragmentShaderModule, const emberSpirvReflect::ShaderReflection& shaderReflection)
    {
        // Vertex shader:

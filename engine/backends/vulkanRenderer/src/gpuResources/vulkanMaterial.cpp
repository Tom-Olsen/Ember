...
namespace vulkanRendererBackend
{
	...
	{
		Material material(MaterialShader::CreateOutline(name, vertexSpv, fragmentSpv));
	...
	{
		Material material(MaterialShader::CreateForward(name, vertexSpv, fragmentSpv));
	...
	{
		Material material(MaterialShader::CreateGizmo(name, vertexSpv, fragmentSpv));
	...
	{
		Material material(MaterialShader::CreateShadow(name, shadowMapResolution, vertexSpv));
	...
	{
		Material material(MaterialShader::CreatePresent(name, vertexSpv, fragmentSpv));
	...
	{
		return m_pMaterialShader->GetName();
	}
	emberCommon::MaterialType Material::GetMaterialType() const
	{
		return m_pMaterialShader->GetMaterialType();
	}
	...
	{
		return m_pMaterialShader->GetDescriptorSetBinding();
	}
	...
	// Private methods:
	// Constructor:
	Material::Material(std::shared_ptr<MaterialShader> pMaterialShader)
	{

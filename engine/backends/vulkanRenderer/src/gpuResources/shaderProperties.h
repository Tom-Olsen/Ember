#ifndef __INCLUDE_GUARD_vulkanRendererBackend_shaderProperties_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_shaderProperties_h__
#include <memory>
#include <string>
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_shaderProperties_h__
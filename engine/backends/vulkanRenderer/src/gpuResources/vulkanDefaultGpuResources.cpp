...
namespace vulkanRendererBackend
{
	...
	void DefaultGpuResources::Init()
	{
		...
		s_pDefaultSampleTexture2d = std::make_unique<SampleTexture2d>("white", 1, 1, Float4::white);
		s_pNormalMapSampleTexture2d = std::make_unique<SampleTexture2d>("defaultNormalMap", 1, 1, Float4::up);

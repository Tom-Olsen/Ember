#ifndef __INCLUDE_GUARD_vulkanRendererBackend_shader_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_shader_h__
#include <filesystem>
#include <memory>
#include <string>
#include <vector>
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_shader_h__
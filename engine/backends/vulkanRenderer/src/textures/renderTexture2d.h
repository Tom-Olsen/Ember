#ifndef __INCLUDE_GUARD_vulkanRendererBackend_renderTexture2d_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_renderTexture2d_h__
#include "texture2d.h"
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_renderTexture2d_h__
#ifndef __INCLUDE_GUARD_vulkanRendererBackend_stagingBufferPool_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_stagingBufferPool_h__
#include <memory>
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_stagingBufferPool_h__
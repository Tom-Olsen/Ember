...
// Naming macros:
    ...
    #define NAME_VK_DEVICE_MEMORY(deviceMemory, name)                   vulkanRendererBackend::Context::SetObjectName(deviceMemory, name)
    ...
    #define NAME_VK_PIPELINE_LAYOUT(pipelineLayout, name)               vulkanRendererBackend::Context::SetObjectName(pipelineLayout, name)
    ...
    #define NAME_VK_DESCRIPTOR_SET_LAYOUT(descriptorSetLayout, name)    vulkanRendererBackend::Context::SetObjectName(descriptorSetLayout, name)
    #define NAME_VK_DESCRIPTOR_SET(descriptorSet, name)                 vulkanRendererBackend::Context::SetObjectName(descriptorSet, name)
    #define NAME_VK_DESCRIPTOR_POOL(descriptorPool, name)               vulkanRendererBackend::Context::descriptorPool(pool, name)
    ...
    #define NAME_VK_SWAPCHAIN_KHR(swapchainKHR, name)                   vulkanRendererBackend::Context::SetObjectName(swapchainKHR, name)
#else
    ...
    #define NAME_VK_DEVICE_MEMORY(deviceMemory, name)                   ((void)0)
    #define NAME_VK_SHADER_MODULE(shaderModule, name)                   ((void)0)
    #define NAME_VK_PIPELINE(pipelineLayout, name)                      ((void)0)
    #define NAME_VK_PIPELINE_LAYOUT(pipelineLayout, name)               ((void)0)
    #define NAME_VK_RENDER_PASS(renderPass, name)                       ((void)0)
    #define NAME_VK_FRAMEBUFFER(framebuffer, name)                      ((void)0)
    #define NAME_VK_DESCRIPTOR_SET_LAYOUT(descriptorSetLayout, name)    ((void)0)
    #define NAME_VK_DESCRIPTOR_SET(descriptorSet, name)                 ((void)0)
    #define NAME_VK_DESCRIPTOR_POOL(descriptorPool, name)               ((void)0)
    ...
    #define NAME_VK_SWAPCHAIN_KHR(swapchainKHR, name)                   ((void)0)
#endif
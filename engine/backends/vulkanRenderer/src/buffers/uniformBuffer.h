#ifndef __INCLUDE_GUARD_vulkanRendererBackend_uniformBuffer_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_uniformBuffer_h__
#include "buffer.h"
#include <string>
#include <vector>
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_uniformBuffer_h__
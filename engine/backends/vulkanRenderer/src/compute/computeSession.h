#ifndef __INCLUDE_GUARD_vulkanRendererBackend_computeSession_h__
#define __INCLUDE_GUARD_vulkanRendererBackend_computeSession_h__
#include <vector>
...
#endif // __INCLUDE_GUARD_vulkanRendererBackend_computeSession_h__
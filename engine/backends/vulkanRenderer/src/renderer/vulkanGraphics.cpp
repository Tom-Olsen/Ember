...
namespace vulkanRendererBackend
{
	...
	void Graphics::Init()
	{
		...
		std::filesystem::path directoryPath = std::filesystem::path(VULKAN_LIBRARY_ROOT_PATH) / "src" / "shaders";
		...
		s_pShadowMaterial = std::make_unique<Material>(emberEngine::MaterialType::shadow, "shadowMaterial", emberEngine::RenderQueue::shadow, directoryPath / "shadow.vert.spv");
		s_pDefaultMaterial = std::make_unique<Material>(emberEngine::MaterialType::forwardOpaque, "defaultMaterial", emberEngine::RenderQueue::opaque, directoryPath / "default.vert.spv", directoryPath / "default.frag.spv");
		s_pErrorMaterial = std::make_unique<Material>(emberEngine::MaterialType::forwardOpaque, "errorMaterial", emberEngine::RenderQueue::opaque, directoryPath / "error.vert.spv", directoryPath / "error.frag.spv");
		s_pPresentMaterial = std::make_unique<Material>(emberEngine::MaterialType::forwardOpaque, "presentMaterial", emberEngine::RenderQueue::opaque, directoryPath / "present.vert.spv", directoryPath / "present.frag.spv");
		s_pGammaCorrectionComputeShader = std::make_unique<ComputeShader>("gammaCorrectionComputeShader", directoryPath / "gammaCorrection.comp.spv");
	}
	void Graphics::Clear()
	{
		ResetDrawCalls();

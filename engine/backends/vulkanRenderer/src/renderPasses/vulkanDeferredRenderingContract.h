...
namespace vulkanRendererBackend
{
	namespace deferredRenderingContract
	{
		...
		inline constexpr VkFormat surfacePropertiesFormat = VK_FORMAT_R8G8B8A8_UNORM;	// r = metallicity, g = roughness, b = ambient occlusion, a = flags
		...
		inline constexpr uint32_t surfacePropertiesAttachmentIndex = 2;

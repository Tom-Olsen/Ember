...
namespace emberCore
{
	...
	{
		return MaterialShaderManager::CreateOutlineMaterialShader(vertexSpv, fragmentSpv, name);
	}
	...
	{
		return MaterialShaderManager::CreatePresentMaterialShader(vertexSpv, fragmentSpv, name);
	}

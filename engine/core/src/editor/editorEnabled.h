...
namespace emberEngine
{
	...
	public: // Methods:
		...
		static bool InputInt(const std::string& label, int* v, int step = 1, int step_fast = 100, DearImGuiWindowFlags flags = 0);
		static bool DragInt(const std::string& label, int* v, int step = 1, int step_fast = 100, DearImGuiWindowFlags flags = 0);
		static bool InputFloat(const std::string& label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", DearImGuiWindowFlags flags = 0);
		static bool DragFloat(const std::string& label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", DearImGuiWindowFlags flags = 0);

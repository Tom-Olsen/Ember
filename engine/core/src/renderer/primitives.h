...
namespace emberCore
{
	...
	public: // Methods:
        ...
        static ShaderProperties DrawConeSmooth(const Float4x4& localToWorldMatrix, const Material& material, bool receiveShadows, bool castShadows, bool asGizmo);
        static ShaderProperties DrawConeFlat(const Float4x4& localToWorldMatrix, const Material& material, bool receiveShadows, bool castShadows, bool asGizmo);
		...
		static void DrawCapsule(const Capsule& capsule, const Material& material, const Float4& color, bool receiveShadows, bool castShadows, bool asGizmo);
		...
		static void DrawRotatedBounds(const Float4x4& localToWorldMatrix, const RotatedBounds& bounds, float width, const Material& material, const Float4& color, bool receiveShadows, bool castShadows, bool asGizmo);
	};
}
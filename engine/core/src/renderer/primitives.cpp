...
namespace emberCore
{
    ...
    ShaderProperties Primitives::DrawConeSmooth(const Float4x4& localToWorldMatrix, const Material& material, bool receiveShadows, bool castShadows, bool asGizmo)
    {
        return DrawMesh(MeshManager::GetMesh("coneSmooth"), material, localToWorldMatrix, receiveShadows, castShadows, asGizmo);
    }

    ShaderProperties Primitives::DrawConeFlat(const Float4x4& localToWorldMatrix, const Material& material, bool receiveShadows, bool castShadows, bool asGizmo)
    {
        return DrawMesh(MeshManager::GetMesh("coneFlat"), material, localToWorldMatrix, receiveShadows, castShadows, asGizmo);
    }
	...
	void Primitives::DrawRotatedBounds(const Float4x4& localToWorldMatrix, const RotatedBounds& bounds, float width, const Material& material, const Float4& color, bool receiveShadows, bool castShadows, bool asGizmo)
	{
		std::array<Float3, 8> corners = bounds.GetCorners();

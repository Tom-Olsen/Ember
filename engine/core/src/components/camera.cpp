...
namespace emberEngine
{
	...
	{
		Renderer::SetActiveCamera(GetTransform()->GetPosition(), GetViewMatrix(), GetProjectionMatrix());
		if (m_drawFrustum)
			Renderer::DrawFrustum(m_pTransform->GetLocalToWorldMatrix(), GetProjectionMatrix());
	}

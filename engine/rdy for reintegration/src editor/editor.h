...
namespace emberBackend
{
	...
	class Editor : public emberBackendInterface::IEditor
	{
	private: // Members:
	...
	public: // Methods:
		...
		bool InputInt(const std::string& label, int* v, int step = 1, int step_fast = 100, DearImGuiWindowFlags flags = 0);
		bool DragInt(const std::string& label, int* v, int step = 1, int step_fast = 100, DearImGuiWindowFlags flags = 0);
		bool InputFloat(const std::string& label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", DearImGuiWindowFlags flags = 0);
		bool DragFloat(const std::string& label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", DearImGuiWindowFlags flags = 0);

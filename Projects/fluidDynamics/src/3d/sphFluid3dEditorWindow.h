#ifndef __INCLUDE_GUARD_sphFluid3dEditorWindow_h__
#define __INCLUDE_GUARD_sphFluid3dEditorWindow_h__
...
{
	struct SphFluid3dEditorWindow : EditorWindow
	{
	private:
		SphFluid3d* m_pScript;
		bool m_isRunning;
		float m_timeScale;
	...
	public:
		SphFluid3dEditorWindow(SphFluid3d* pScript)
		{
			m_pScript = pScript;
			GetData();
		...
		{
			GetData();
			ImGui::Begin("Sph Fluid 3d Editor Window");
			{
...
#endif // __INCLUDE_GUARD_sphFluid3dEditorWindow_h__
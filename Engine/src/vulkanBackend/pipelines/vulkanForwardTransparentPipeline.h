#ifndef __INCLUDE_GUARD_vulkanForwardTransparentPipeline_h__
#define __INCLUDE_GUARD_vulkanForwardTransparentPipeline_h__
...
#endif // __INCLUDE_GUARD_vulkanForwardTransparentPipeline_h__
#ifndef __INCLUDE_GUARD_vulkanForwardOpaquePipeline_h__
#define __INCLUDE_GUARD_vulkanForwardOpaquePipeline_h__
...
#endif // __INCLUDE_GUARD_vulkanForwardOpaquePipeline_h__
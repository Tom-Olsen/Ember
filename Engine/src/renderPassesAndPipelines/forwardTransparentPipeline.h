#ifndef __INCLUDE_GUARD_forwardTransparentPipeline_h__
#define __INCLUDE_GUARD_forwardTransparentPipeline_h__
#include "pipeline.h"
#include <vector>
...
#endif // __INCLUDE_GUARD_forwardTransparentPipeline_h__
...
public:
	static void SetUpTestSuite()
	{
		...
		Material::CreateForward(emberCommon::ForwardRenderMode::transparent, "particleMaterial2d", directoryPath / "particle2d.vert.spv", directoryPath / "particle2d.frag.spv");
	}

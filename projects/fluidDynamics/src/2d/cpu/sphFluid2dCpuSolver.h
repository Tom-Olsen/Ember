...
namespace fluidDynamics
{
	...
	public: // Methods:
		...
		static float NearDensity(int particleIndex, const Settings& settings, const std::vector<Float2>& positions);
		static float NearDensity(int particleIndex, const Settings& settings, const std::vector<Float2>& positions, HashGrid2d& hashGrid);
		...
		static Float2 InternalForceDensity(int particleIndex, const Settings& settings, const std::vector<Float2>& positions, const std::vector<float>& densities, const std::vector<float>& nearDensities, const std::vector<Float2>& velocities);
		static Float2 InternalForceDensity(int particleIndex, const Settings& settings, const std::vector<Float2>& positions, const std::vector<float>& densities, const std::vector<float>& nearDensities, const std::vector<Float2>& velocities, HashGrid2d& hashGrid);
		...
		// Field computations:
		static void ComputeDensities(const Settings& settings, std::vector<float>& densities, std::vector<float>& nearDensities, const std::vector<Float2>& positions);
		...
		static void ComputeForceDensities(const Settings& settings, const Attractor& attractor, std::vector<Float2>& forceDensities, const std::vector<Float2>& positions, const std::vector<float>& densities, const std::vector<float>& nearDensities, const std::vector<Float2>& velocities, const std::vector<Float2>& normals, const std::vector<float>& curvatures);
	};
}
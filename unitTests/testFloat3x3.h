...
TEST(Float3x3, Access)
{
	...
	EXPECT_FLOAT_EQ(matrix01, d);
	EXPECT_FLOAT_EQ(matrix02, g);
	EXPECT_FLOAT_EQ(matrix10, b);
	EXPECT_FLOAT_EQ(matrix11, e);
	EXPECT_FLOAT_EQ(matrix12, h);
	EXPECT_FLOAT_EQ(matrix20, c);
	EXPECT_FLOAT_EQ(matrix21, f);
	EXPECT_FLOAT_EQ(matrix22, i);
}

...
TEST(Float4x4, Access)
{
	...
	EXPECT_FLOAT_EQ(matrix01, e);
	EXPECT_FLOAT_EQ(matrix02, i);
	EXPECT_FLOAT_EQ(matrix03, m);
	EXPECT_FLOAT_EQ(matrix10, b);
	EXPECT_FLOAT_EQ(matrix11, f);
	EXPECT_FLOAT_EQ(matrix12, j);
	EXPECT_FLOAT_EQ(matrix13, n);
	EXPECT_FLOAT_EQ(matrix20, c);
	EXPECT_FLOAT_EQ(matrix21, g);
	EXPECT_FLOAT_EQ(matrix22, k);
	EXPECT_FLOAT_EQ(matrix23, o);
	EXPECT_FLOAT_EQ(matrix30, d);
	EXPECT_FLOAT_EQ(matrix31, h);
	EXPECT_FLOAT_EQ(matrix32, l);
	EXPECT_FLOAT_EQ(matrix33, p);
}
